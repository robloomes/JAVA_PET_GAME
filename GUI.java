...
public class GUI implements gameObjects {
	...
	JLabel lblPetCreationScreen = new JLabel("Pet creation screen");
	...
	public void guiConstructor() {
		...
		lblNewLabel_3.setBounds(104, 315, 193, 178);
		...
		lblNamePrompt.setBounds(276, 477, 698, 83);
		...
		txtPetName1.setBounds(128, 255, 130, 31);
		txtPetName1.setVisible(false);
		txtPetName1.setText("Enter a name...");
		creationPanel.add(txtPetName1);
		txtPetName1.setColumns(10);
		lblPetCreationScreen.setBounds(456, 25, 321, 44);

		lblPetCreationScreen.setVisible(false);
		creationPanel.add(lblPetCreationScreen);

		txtPetName2 = new JTextField();
		txtPetName2.setBounds(819, 169, 130, 31);
		txtPetName2.setVisible(false);
		txtPetName2.setText("Enter a name...");
		txtPetName2.setColumns(10);
		creationPanel.add(txtPetName2);

		txtPetName3 = new JTextField();
		txtPetName3.setBounds(819, 212, 130, 31);
		txtPetName3.setVisible(false);
		txtPetName3.setText("Enter a name...");
		txtPetName3.setColumns(10);
		creationPanel.add(txtPetName3);

		txtPetName4 = new JTextField();
		txtPetName4.setBounds(819, 259, 130, 31);
		txtPetName4.setVisible(false);
		txtPetName4.setText("Enter a name");
		txtPetName4.setColumns(10);
		creationPanel.add(txtPetName4);

		txtPetName5 = new JTextField();
		txtPetName5.setBounds(819, 302, 130, 31);
		txtPetName5.setVisible(false);
		txtPetName5.setText("Enter a name...");
		txtPetName5.setColumns(10);
		creationPanel.add(txtPetName5);

		txtPetName6 = new JTextField();
		txtPetName6.setBounds(819, 357, 130, 31);
		txtPetName6.setVisible(false);
		txtPetName6.setText("Enter a name...");
		txtPetName6.setColumns(10);
		creationPanel.add(txtPetName6);
		chckbxPet1.setBounds(139, 216, 129, 23);

		chckbxPet1.setVisible(false);
		creationPanel.add(chckbxPet1);
		chckbxPet2.setBounds(648, 173, 129, 23);

		chckbxPet2.setVisible(false);
		creationPanel.add(chckbxPet2);
		chckbxPet3.setBounds(648, 216, 129, 23);

		chckbxPet3.setVisible(false);
		creationPanel.add(chckbxPet3);
		chckbxPet4.setBounds(648, 263, 129, 23);

		chckbxPet4.setVisible(false);
		creationPanel.add(chckbxPet4);
		chckbxPet5.setBounds(648, 306, 129, 23);

		chckbxPet5.setVisible(false);
		creationPanel.add(chckbxPet5);
		chckbxPet6.setBounds(648, 361, 129, 23);

		chckbxPet6.setVisible(false);
		creationPanel.add(chckbxPet6);
		lblSelectUpTo.setBounds(654, 95, 218, 15);
		...
		lblNewLabel_1.setBounds(104, 24, 193, 176);
