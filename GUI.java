...
public class GUI implements gameObjects {
	...
	private final JLabel lblNewLabel_6 = new JLabel("<html>Cloud: seems to care only <br> about itself,but can bring great joy to others.\n");
	private final JLabel lblNewLabel_3 = new JLabel("<html>Penguin: not much to be <br>said about this black and white companion.");
	private final JLabel lblNewLabel_7 = new JLabel("<html>Crab: loyal but simple.<br> Obsessed with toys.");
	private final JLabel lblNewLabel_8 = new JLabel("<html>Robot: has great personality for<br> a machine. Spends most of his time recharging his batteries.");
	private final JLabel lblNewLabel_9 = new JLabel("<html>Monster: while scary looking, <br>has a gentle heart beneath the rugged fur.");
	private final JLabel lblNewLabel_10 = new JLabel("<html>Snake: is as slippery as he<br> is untrustworthy. Keep a close eye on this one.\\n");
