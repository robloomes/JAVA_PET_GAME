...
public class Pet {
	...
	public String toString() {
		...
		String petStats = String.format("%s<br>%s<br>%s<br>%s<br>%s<br>%s<br>%s<br>%s<br>%s<br>%s<br>%s<br>%s<br>",
				petName, petWeight, petAge, petMood, petEnergy, petHealth, petHunger, petToiletNeed, petAlive,
				petRevive, petSick, petMisbehave);
		return petStats;
	}
